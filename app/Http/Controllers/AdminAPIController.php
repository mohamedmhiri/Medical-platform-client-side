...
class AdminAPIController extends BaseController
{
	...
	/*herrrrrrrrre*/
		 // $endDate= strtotime('+30 minutes', strtotime("$a['appointment_datetime']");


   		// $endDate = date('Y-m-d H:i',$endDate );

			$endDate = date_add($endDate, date_interval_create_from_date_string('30 min'));
			$event = array(
				'id' => $a['id'],
		...
		//return var_dump($calendarAppointments);
	...
	public static function DeleteAppointment($id)
	{
		...
		return (new AdminController)->appointments();
	}
